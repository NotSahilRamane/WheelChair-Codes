...
sys.path.append('/home/sahil/Robin/src/segmentation/scripts/yolov7')
# print(sys.path)
...
class Segmentation: 
    def __init__(self):
        ...
        print(self.device)
        with open('/home/sahil/Robin/src/segmentation/scripts/yolov7/data/hyp.scratch.mask.yaml') as f:
            self.hyp = yaml.load(f, Loader=yaml.FullLoader)
            # print("Loaded asoifns lfnijwilfhsliwfjslirgbjrwaiogbja ")
        weigths = torch.load("/home/sahil/Robin/src/segmentation/scripts/yolov7/yolov7-mask.pt")
        model = weigths['model']
